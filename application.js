$(document).ready(function(){
  ...
  $('#first_a').hover(
    ...
    $('#first_a').prepend('<img class="arrow_left" src="images/arrow-left.png">');
  ...
  $('#second_a').hover(
    function(){
    $default_message.detach();
    $('#second_a').prepend('<img class="arrow_left" src="images/arrow-left.png">');
  ...
  $('#third_a').hover(
    function(){
    $default_message.detach();
    $('#third_a').prepend('<img class="arrow_right" src="images/arrow-right.png">');
